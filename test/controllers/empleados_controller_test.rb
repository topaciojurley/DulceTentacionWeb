...
class EmpleadosControllerTest < ActionController::TestCase
  ...
  test "should create empleado" do
    assert_difference('Empleado.count') do
      post :create, empleado: { apellido: @empleado.apellido, correo: @empleado.correo, direccion: @empleado.direccion, fechanacimiento: @empleado.fechanacimiento, nombre: @empleado.nombre, rut: @empleado.rut, telefono: @empleado.telefono }
    end
  ...
  test "should update empleado" do
    patch :update, id: @empleado, empleado: { apellido: @empleado.apellido, correo: @empleado.correo, direccion: @empleado.direccion, fechanacimiento: @empleado.fechanacimiento, nombre: @empleado.nombre, rut: @empleado.rut, telefono: @empleado.telefono }
    assert_redirected_to empleado_path(assigns(:empleado))
  end
